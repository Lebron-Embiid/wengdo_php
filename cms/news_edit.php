<?php 
    ...
    if($_POST){
        ...
        if(in_array($up_name, $arr)){
            ...
            $sql = "UPDATE wd_news SET news_title='$up_name',news_time='$time',news_text='$up_text' WHERE news_id=$up_id";
            mysql_query($sql);
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="input-group"><span class="input-group-addon">内容</span>
                                            <textarea name="content" id="" cols="30" rows="10"><?php echo $news['news_text'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7">
