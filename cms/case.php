...
<div id="main">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li class="active">
          <a href="case.php"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">案例分类管理</span></a>
        </li>
        <li>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">案例分类管理</div>
                        </div>
