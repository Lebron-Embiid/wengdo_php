<?php 
    ...
    if($_POST){
        ...
        $sql = "INSERT INTO wd_banner(ban_img,ban_link,ban_thu) VALUES('$ban_img','$ban_link','$ban_thu')";
        mysql_query($sql);
        // exit;
        if(mysql_affected_rows()){
            alert("图片上传成功!","banner_list.php");
        }
    }
 ?>
<!DOCTYPE html>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">文件</span>
