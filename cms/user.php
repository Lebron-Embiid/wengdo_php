<?php 
    ...
    if($_POST){
      foreach($_POST['check'] as $val){
        $sql = "DELETE FROM wd_user WHERE user_id=$val";
        mysql_query($sql);
      }
    ...
    $count = "SELECT COUNT(user_id) as count FROM wd_user";
    ...
    $sql = "SELECT * FROM wd_user ORDER BY user_id ASC LIMIT $strpage,$limit";
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php foreach($user as $val){ ?>
                    	<tr class="success">
                        <td class="text-center"><input type="checkbox" value="<?php echo $val['user_id'] ?>" name="check[]" class="cbox"></td>
                        <td><?php echo $val['user_name'] ?></td>
                        <td><?php echo $val['user_password'] ?></td>
                        <td>
		                      <div class="btn-group">
		                        <a href="user_edit.php?id=<?php echo $val['user_id'] ?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
		                        <a onclick="return confirm('确定要删除吗？');" href="user_del.php?did=<?php echo $val['user_id'] ?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicons glyphicon-trash"></span></a>
		                      </div>
                        </td>
                      </tr>
                      <?php } ?>
