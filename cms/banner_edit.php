<?php 
    ...
    if($_GET){
        $up_id = $_GET['id'];
        $sql = "SELECT * FROM wd_banner WHERE ban_id=$up_id";
        $ban = getArr($sql);
    ...
    if($_POST){
        ...
        // $sqld = "DELETE FROM wd_banner WHERE ban_id=$up_id";
        // mysql_query($sqld);
        ...
        // echo $thumd;
        // exit;
        $ban_img = $upload['filename'];
        $ban_link = $_POST['link'];
        $ban_thu = $thumd;

        // $sql = "INSERT INTO wd_banner(ban_id,ban_img,ban_link,ban_thu) VALUES('$up_id','$ban_img','$ban_link','$ban_thu')";
        $sql = "UPDATE wd_banner SET ban_img='$ban_img',ban_link='$ban_link',ban_thu='$ban_thu' WHERE ban_id=$up_id";
        mysql_query($sql);
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">原图片</span>
                                            <img src="<?php echo THUPATH.$ban['ban_thu']; ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">链接</span>
                                            <input type="text" name="link" value="<?php echo $ban['ban_link']; ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7">
