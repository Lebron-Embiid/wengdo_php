<?php 
    ...
    if($_GET){
        $up_id = $_GET['id'];
        $sql = "SELECT * FROM wd_partner WHERE par_id=$up_id";
        $par = getArr($sql);
    ...
    if($_POST){
        ...
        // echo $thumd;
        // exit;
        $par_img = $upload['filename'];
        $par_link = $_POST['link'];
        $par_thum = $thumd;

        // $sql = "INSERT INTO wd_case(case_id,case_img,case_title,case_thum) VALUES('$up_id','$case_img','$case_title','$case_thum')";
        $sql = "UPDATE wd_partner SET par_img='$par_img',par_link='$par_link',par_thum='$par_thum' WHERE par_id=$up_id";
        mysql_query($sql);
        alert("修改成功!","part_list.php");
    }
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">原图片</span>
                                            <img src="<?php echo THUPATH.$par['par_thum']; ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">链接</span>
                                            <input type="text" name="link" value="<?php echo $par['par_link']; ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-7">
