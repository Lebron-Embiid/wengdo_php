<?php 
  ...
  if($_POST){
    foreach($_POST['check'] as $val){
      $sql = "SELECT * FROM wd_partner WHERE par_id=$val";
      $par = getArr($sql);
      ...
      $sql = "DELETE FROM wd_partner WHERE par_id=$val";
      mysql_query($sql);
    }
  ...
  $count = "SELECT COUNT(par_id) as count FROM wd_partner";
  ...
  $sql = "SELECT * FROM wd_partner ORDER BY par_id ASC LIMIT $strpage,$limit";
  $part = sql_fn($sql);
  // print_r($nav);
  //缩略图
  ...
  <aside id="sidebar" class="affix">
    ...
    <div id="sidebar-menu">
      <ul class="nav sidebar-nav">
        ...
        <li class="active"><a href="part_list.php"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">合作伙伴</span></a>
        </li>
        <li>
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  ...
                  <a href="part_add.php" class="btn btn-info btn-gradient pull-right"><span class="glyphicons glyphicon-plus"></span> 添加缩略图</a>
                </div>
                ...
                <div class="panel-body">
                  ...
                  <table class="table table-striped table-bordered table-hover dataTable">
                      ...
                      <?php foreach($part as $val){ ?>
                    	<tr class="success">
                        <td class="text-center"><input type="checkbox" value="<?php echo $val['par_id'] ?>" name="check[]" class="cbox"></td>
                        <td><img src="<?php echo THUPATH.$val['par_thum'] ?>" alt=""></td>
                        <td><?php echo $val['par_link'] ?></td>
                        <td>
		                      <div class="btn-group">
		                        <a href="part_edit.php?id=<?php echo $val['par_id'] ?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
		                        <a onclick="return confirm('确定要删除吗？')" href="part_del.php?did=<?php echo $val['par_id'] ?>" class="btn btn-default btn-gradient dropdown-toggle"><span class="glyphicons glyphicon-trash"></span></a>
		                      </div>
                        </td>
                      </tr>
                      <?php } ?>
